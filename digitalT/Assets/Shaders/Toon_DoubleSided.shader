Shader "DT_Shaders/Toon_DoubleSided" {
    Properties {
...
/////// Diffuse:
                ...
                finalColor += diffuseLight * tex2D(_DiffuseMap,TRANSFORM_TEX(node_29.rg, _DiffuseMap)).rgb;
/// Final Color:
...
/////// Diffuse:
                ...
                finalColor += diffuseLight * tex2D(_DiffuseMap,TRANSFORM_TEX(node_30.rg, _DiffuseMap)).rgb;
/// Final Color:
